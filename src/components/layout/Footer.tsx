...
export default function Footer() {
  ...
  return (
    <footer className="bg-background-surface border-t border-border mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-primary mb-4">DROP FIT</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/drops" className="text-text-secondary hover:text-primary transition-colors">
                  Drops
                </Link>
              </li>
              <li>
                <Link href="/community" className="text-text-secondary hover:text-primary transition-colors">
                  Community
                </Link>
              </li>
              <li>
